...
## ترحيلات تم التحقق من تسجيلها لاحقًا في Production

> **الحالة التاريخية المصححة:** كانت هذه الفقرة لقطة قبل تحقق Production. ثَبُت لاحقًا بسجل migrations الحي في 25 أغسطس 2026 أن الترحيلين مسجلان في مشروع Production `bqvcukxfsnchvkgejolz` بالإصدارين `20260824230654` و`20260824231127` على الترتيب. لا يبرر ذلك إنشاء حسابات حقيقية أو أي DDL مباشر خارج migration مصدرية.

| ملف المستودع | الاسم المسجل في Production | الغرض | نتيجة تحقق القراءة فقط |
|---|---|---|---|
