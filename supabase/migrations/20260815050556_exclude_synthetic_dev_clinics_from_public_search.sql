-- Public search must never present synthetic DEV fixtures as participating clinics.
-- This guard is data-driven (verification source), not dependent on a display-name convention.
