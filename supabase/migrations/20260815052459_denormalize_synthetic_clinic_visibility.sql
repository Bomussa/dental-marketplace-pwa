-- Public search must not depend on a private-table lookup at request time.
-- Persist the synthetic-fixture marker on the clinic record and keep search fully SECURITY INVOKER.
...
drop function if exists private.is_public_searchable_clinic(uuid);
