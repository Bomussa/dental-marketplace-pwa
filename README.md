...
> **حالة هذه العقود:** نُشر كود ومخطط ميزات nickname وتفرد الهاتف والإشعارات الداخلية والخرائط وتفضيل جنس الممارس والحذف المقيد إلى Production في commit `7f814fc`، وسجّل Supabase الترحيلين تحت `20260826122625` و`20260826122705`. ظل الإثبات الوظيفي الكامل للحجز والإشعار والحذف محصورًا في Preview Staging ضمن `TEST_STG` ثم نُظفت fixture إلى صفر؛ لم يُنشأ أي حساب أو حجز أو OTP اختباري في Production. لا يزال OTP الحقيقي blocker تشغيليًا عند غياب تهيئة المزود. راجع [`docs/CURRENT_PRODUCTION_STATUS.md`](docs/CURRENT_PRODUCTION_STATUS.md) للحكم الحالي وحدود الإثبات.
