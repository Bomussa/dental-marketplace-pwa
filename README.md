...
> **حالة هذه العقود:** ميزات nickname وتفرد الهاتف والإشعارات الداخلية والخرائط وتفضيل جنس الممارس والحذف المقيد اختُبرت في Preview Staging فقط ضمن `TEST_STG` ثم نُظفت. لا تعد هذه الفقرة نشرًا إلى Production؛ راجع [`docs/CURRENT_PRODUCTION_STATUS.md`](docs/CURRENT_PRODUCTION_STATUS.md) قبل أي دمج أو نشر.
