...
| كتالوج العلاج | تحيط `getActiveTreatmentCatalog` قراءات الكتالوج المحكومة بمهلة بتعافٍ خادمي؛ عند مهلة عابرة يعيد صفيفين فارغين و`hasError=true` كي تعرض الصفحة تنبيه الخطأ المتاح بدلاً من رفض SSR بالكامل. |
