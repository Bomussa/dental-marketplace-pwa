...
| تسجيل المريض | تتطلب البداية الاسم والرقم الشخصي والجنسية والهاتف وبيانات الدخول؛ تستمد الجنسية من 249 رمز ISO 3166-1 alpha-2 في [`lib/account-nationality-options.ts`](lib/account-nationality-options.ts). تاريخ الميلاد والجنس اختياريان عند إنشاء الحساب، لكن تاريخ الميلاد يصبح لازمًا قبل تأكيد الحجز. كلمة مرور المريض 4–10 أحرف أو أرقام إنجليزية؛ تبقى حسابات العيادات والعملاء التشغيليين على سياسة كلمة مرور أقوى ومنفصلة. |
