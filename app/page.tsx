...
export default async function HomePage() {
  ...
  return (
    <main className="home-page overflow-hidden">
      <section className="home-hero premium-hero relative isolate px-4 pb-16 pt-14 sm:px-6 sm:pb-24 sm:pt-24">
        <div className="hero-mesh pointer-events-none absolute inset-x-0 top-0 h-[760px] sm:h-[790px]" />
        <div className="home-hero__veil pointer-events-none absolute inset-x-0 top-0 h-[760px] sm:h-[790px]" />
        <div className="home-hero__halo pointer-events-none absolute" />
        <div className="relative mx-auto max-w-7xl">
          <div className="mx-auto max-w-4xl text-center">
            <div className="reveal mb-7 flex flex-wrap justify-center gap-2">
            ...
            <h1 className="home-hero__title reveal reveal-delay-1 mx-auto max-w-5xl text-[2.7rem] font-black leading-[1.06] tracking-[-.052em] text-white drop-shadow-[0_14px_36px_rgba(0,11,37,.50)] sm:text-6xl lg:text-7xl">
              {t["home.hero.before"]} <span className="home-hero__accent">{t["home.hero.highlight"]}</span> {t["home.hero.after"]}
            </h1>
            <p className="reveal reveal-delay-2 mx-auto mt-7 max-w-2xl text-[.98rem] font-medium leading-8 text-blue-50/92 sm:text-lg">{t["home.intro"]}</p>
          </div>

          <div className="home-search-card reveal reveal-delay-2 mx-auto mt-10 max-w-6xl p-3 sm:mt-12 sm:p-4">
          ...
          <div className="trust-row reveal reveal-delay-2 mx-auto mt-6 flex max-w-5xl flex-wrap items-center justify-center gap-2.5 text-xs font-bold text-blue-50/95">
      ...
      <section className="relative z-10 mx-auto -mt-3 max-w-7xl px-4 pb-16 sm:px-6">
        <div className="grid gap-4 sm:grid-cols-3">
          {[[String(treatmentRows.length),t["home.metric.treatments"],t["home.metric.treatmentsDetail"]],[String(variantRows.length),t["home.metric.variants"],t["home.metric.variantsDetail"]],["QAR",t["home.metric.currency"],t["home.metric.currencyDetail"]]].map(([value,label,detail]) => (
            <div key={label} className="metric-card home-metric lift rounded-[28px] border border-white/85 p-6 shadow-[0_24px_62px_-42px_rgba(4,37,83,.46)] ring-1 ring-[#07528d]/[.07]">
      ...
      <section className="decision-section relative mx-4 overflow-hidden rounded-[34px] border border-white/70 px-4 py-16 shadow-[0_30px_80px_-60px_rgba(5,39,85,.62)] sm:mx-6 sm:px-6">
