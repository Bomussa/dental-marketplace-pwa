...
export default function manifest(): MetadataRoute.Manifest {
  ...
  return { id: "/", name: "أسناني قطر", short_name: "أسناني", description: "مقارنة أسعار الأسنان والتوفر والحجز في قطر", start_url: "/", scope: "/", display: "standalone", background_color: "#f5f7fb", theme_color: "#007AFF", lang: "ar", dir: "rtl", icons };
}
