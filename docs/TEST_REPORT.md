...
| Playwright | **52 اختباراً ناجحاً** | سطح المكتب والهاتف، البحث، العزل، الدخول، المسارات المحمية، حارس أصل تسجيل الخروج، القراءة العامة المباشرة لكل كيانات العيادات التجريبية، CSP وPWA. |
