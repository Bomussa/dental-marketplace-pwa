...
| بوابة الجودة | ناجحة | 64 اختبار وحدة و50 اختبار متصفح، إضافة إلى TypeScript وESLint وبناء الإنتاج ضمن `npm run verify`. |
...
| الأمان | RLS، عمليات خادمية مقيدة، حارس الكتابة العامة، حارس أصل تسجيل الخروج، وسياسات منع التعديل العميل المباشر للعمليات الحرجة. |
