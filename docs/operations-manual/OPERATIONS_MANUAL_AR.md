...
افتح [الموقع الرسمي](https://www.mmc-mms.com). يمكن للزائر البحث والمقارنة من دون تسجيل دخول. للدخول إلى حساب المريض أو لوحة العيادة، اختر **«دخول»** ثم اكتب البريد الإلكتروني واضغط **«إرسال رابط الدخول»**. تصل رسالة تحقق أحادية الاستخدام إلى البريد، وبعد فتحها يعود المستخدم إلى الوجهة التي طلبها.
...
*الصورة 2 — شاشة الدخول الحية. لا توجد كلمة مرور داخل التطبيق.*
...
بعد ظهور عرض يملك موعدًا صالحًا، اضغط **«احجز هذا الموعد»**. إذا لم تكن مسجّلًا، يحوّلك التطبيق إلى شاشة الدخول ثم يعيدك إلى نتيجة العرض بعد تأكيد رابط البريد.
...
| المصدر | ماذا يثبت |
|---|---|
| [`app/clinic/page.tsx`](../../app/clinic/page.tsx) و[`app/clinic/actions.ts`](../../app/clinic/actions.ts) | أقسام لوحة العيادة، الأدوار، ونماذج الفروع والعروض والمواعيد والحجوزات. |
| [`app/admin/page.tsx`](../../app/admin/page.tsx) و[`app/admin/actions.ts`](../../app/admin/actions.ts) | أدوات الإدارة وحالات التحكم والحوكمة. |
| [`app/account/actions.ts`](../../app/account/actions.ts) و[`components/book-button.tsx`](../../components/book-button.tsx) | ملف المريض، OTP، الحجز، الإلغاء، والتقييم. |
...
| `sendMagicLink` | كل مستخدم | اكتب البريد ثم أرسل رابط الدخول. | [1.1](#11-الدخول-واللغة) |
