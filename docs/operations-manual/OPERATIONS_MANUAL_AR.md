...
|---|---|---|
| إنشاء حساب المريض | الاسم، الرقم الشخصي، الجنسية، رقم الهاتف، اسم المستخدم، البريد الإلكتروني، وكلمة مرور من **4 إلى 10 أحرف أو أرقام إنجليزية**. تتضمن القائمة جميع رموز الجنسيات ISO 3166-1 alpha-2 المعروضة بلغة الواجهة. | تاريخ الميلاد والجنس. |
| قبل تأكيد الحجز | ملف المريض المكتمل، بما في ذلك تاريخ الميلاد الصحيح، ورقم هاتف قابل للتحقق. | الجنس اختياري. |

عند الحجز، أكمل تاريخ الميلاد إن لم يُدخل أثناء التسجيل، ثم اضغط **«حفظ البيانات وإرسال رمز التحقق»**. أدخل الرمز واضغط **«تأكيد الحجز»**. لا يُنشأ الحجز ما لم يكن الملف كاملًا و`phone_verified_at` مثبتًا.
