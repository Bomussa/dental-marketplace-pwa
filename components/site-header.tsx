...
export async function SiteHeader() {
  ...
  return (
    <header className="sticky top-0 z-50 px-3 pt-3 sm:px-4">
      <div className="glass-shell mx-auto flex min-h-16 max-w-7xl items-center justify-between gap-2 rounded-[24px] px-2.5 py-2 sm:px-3">
        ...
        <nav className="flex shrink-0 items-center gap-1 text-sm font-extrabold text-blue-50" aria-label={t["nav.home"]}>
